                ...
                <form action="{{ route('asesors.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kode_asesor') is-invalid @enderror" 
                               id="kode_asesor" name="kode_asesor" value="{{ old('kode_asesor', $asesors->kode_asesor) }}" required>
                        @error('kode_asesor')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                               id="nama" name="nama" value="{{ old('nama', $asesors->nama) }}" required>
                        @error('nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                               id="email" name="email" value="{{ old('email', $asesors->email) }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_hp') is-invalid @enderror" 
                               id="no_hp" name="no_hp" value="{{ old('no_hp', $asesors->no_hp) }}" required>
                        @error('no_hp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select class="form-select @error('prodis_id') is-invalid @enderror" 
                            ...
                            @foreach ($prodis as $prodi)
                                <option value="{{ $prodi->id }}" 
                                        {{ old('prodis_id', $asesors->prodis_id) == $prodi->id ? 'selected' : '' }}>
